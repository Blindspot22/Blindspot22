...
---
## **💡About Me**:
- Passionate Rust developer and an active contributor/member of the [Rust programming language](https://github.com/rust-lang/rust).
- Co-Founder of the [**Rust Africa Association**](https://rustafrica.org/) and community lead of [**Rust Cameroon**](https://github.com/Rust-Cameroon)
...
- **Decentralized Identity & DIDComm**: Experienced with decentralized Identities and communication.
